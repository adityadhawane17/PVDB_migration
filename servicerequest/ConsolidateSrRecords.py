...
class ConsolidateSR:
    ...
    def load_additional_data_from_sr(self,sr_row):
        ...
        for key, value in Mappings.level_zero_details_mappings.items():
        ...
        #self.logging.info("Populating Level 0 nested Json details")
        for key, value in Mappings.seats_deatils_mappings.items():
        ...
        for item in Mappings.field_date_format_mappings:
