select
        ...
        json_build_object('id', null , 'membershipId', null) as member,
        ...
        as additionalData
    from ( select * from ng_intermediate_data_store.stage_service_request where request_sysid > {primary_key_id} order by ASC request_sysid limit {limit}) ssr
    left join
        (select
