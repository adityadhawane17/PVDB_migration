create view ng_intermediate_data_store.cd_temp_servicerequest as
	select
        ...
        json_build_object(
            ...
            json_agg(json_build_object( // there are 5 columns with preference_2/3/4/5
                'order', 1,
                'venue', null,
                'timing', null,
    ...
    left join
        (select
            ...
            on membership_details.membership_id = ssr.membership_id type = 'Book Cashback Event' limit 100
;